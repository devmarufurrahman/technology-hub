		...
		<section>
			<div className="about wrapper">
				...
				<p>
					...
					appreciating items from 90s TV, music, and art. See if you remember
					old toys, cartoons, or prints of such. Indulge in some nostalgia
					before our world falls back into the dark ages.
				</p>
			</div>
		</section>
	);
